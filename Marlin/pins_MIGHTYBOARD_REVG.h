...
// Limit Switches
//
#define X_MIN_PIN          72   // L0
#define X_MAX_PIN          30   // L1
#define Y_MIN_PIN          14   // L2
#define Y_MAX_PIN          31   // L3
#define Z_MIN_PIN          32   // L6
#define Z_MAX_PIN          15   // L7
...
#define Y_ENABLE_PIN       45   // F6

#define Z_STEP_PIN         48   // K1
#define Z_DIR_PIN          47   // K0
#define Z_ENABLE_PIN       49   // K2
